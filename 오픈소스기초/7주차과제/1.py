...
if __name__ == "__main__" :
    ...
    photo1 = PhotoImage(file = "C:\Python\Python310\gif\dog.gif" )
    photo2 = PhotoImage(file = "C:\Python\Python310\gif\cat.gif" )
    photo3 = PhotoImage(file = "C:\Python\Python310\gif\rabbit.gif" )
